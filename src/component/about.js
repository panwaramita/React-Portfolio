    ...
    <main className="container about-me">
        <div className="row">
            ...
            <div className="col-lg-12">
                ...
                <p>
                    I am Amita. I completed by Bachelor's degree from NIE, Mysore in Information Science branch. I am having 2.5 year's experience in web development. My first project was iDEA, in the iDEA project worked I in the support call department for coding related issues. Function of support call department is to solve all the customer related issues. Some of the issues are related to the data correction and coding correction. I was the part of coding correction team whose responsibility is to check the code and correct all the issues that is related to the call. For the project the environment used are ASP.NET, C#.NET, WCF, XML, SQL SERVER 2005.

The other project in which I worked is Money First, in this project I was involved in the development of Stock Chart tool. The tool is used to display the current status of the Sensex Market. For this Project, I worked in SQL SERVER 2008, JAVASCRPIT, WCF.
